variable "aws_region" {
  description = "AWS region for lab-runtime resources."
  type        = string
...
variable "vpc_cidr" {
  description = "CIDR block for the lab-runtime VPC."
  type        = string
...
variable "public_subnet_cidr" {
  description = "CIDR block for the public subnet that hosts bastion-01 and the NAT Gateway."
  type        = string
...
variable "root_volume_size_gib" {
  description = "Root EBS volume size for both runtime instances."
  type        = number
  default     = 20
...
variable "enable_detailed_monitoring" {
  description = "Enable EC2 detailed monitoring. Disabled by default for the lab-runtime baseline."
  type        = bool
  default     = false
}
